    ...
    return (
        <div id ="Navbar">
            <div className="flex flex-row justify-between">
                <p className="text-xl font-medium pl-[3%] pt-[2%]">Trường đại học A</p>
                <div className="flex flex-row justify-between w-[10%] items-center mr-16 my-6">
            ...
            <div className="font-semibold px-[3%] py-[1%] shadow-[0_1px_16px_rgba(0,0,0,0.1)] flex flex-row justify-between">
                <p className="w-[5%]">Tổ chức</p>
                <div className=""></div>
            </div>
        </div>
    )
